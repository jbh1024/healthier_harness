...
class _$NoticeImpl implements _Notice {
  ...
  @override
  String toString() {
    return 'Notice(id: $id, title: $title, authorName: $authorName, isImportant: $isImportant, viewCount: $viewCount, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, authorName, isImportant, viewCount, createdAt);
...
/// @nodoc
@JsonSerializable()
class _$NoticeDetailImpl implements _NoticeDetail {
  ...
  @override
  String toString() {
    return 'NoticeDetail(id: $id, title: $title, content: $content, authorName: $authorName, isImportant: $isImportant, viewCount: $viewCount, createdAt: $createdAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, content, authorName,
      isImportant, viewCount, createdAt);
...
abstract class _NoticeDetail implements NoticeDetail {
  const factory _NoticeDetail(
      ...
      final bool isImportant,
      final int viewCount,
      required final String createdAt}) = _$NoticeDetailImpl;
